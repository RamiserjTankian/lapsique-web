...
class BookingLandingAnalyticsService
{
    ...
    public static function trackedEventNames(): array
    {
        return [
            ...
            'multi_camera_workflow_viewed',
            'multi_camera_gear_viewed',
            'multi_camera_package_viewed',
            'multi_camera_coverage_selected',
            'multi_camera_format_selected',
            'multi_camera_video_started',
            'multi_camera_video_progress',
            'multi_camera_video_completed',
            'multi_camera_video_navigated',
            'multi_camera_audio_toggled',
            'multi_camera_video_fullscreen_opened',
    ...
    public static function stageDefinitions(): array
    {
        return [
            ...
            ['key' => 'reel_engaged', 'label' => 'Video interactuado', 'color' => 'info', 'events' => ['reel_card_clicked', 'reel_player_opened', 'video_play', 'multi_camera_video_started']],
            ['key' => 'reel_watch', 'label' => 'Reel >25% visto', 'color' => 'info', 'events' => ['reel_watch_milestone', 'multi_camera_video_progress']],
