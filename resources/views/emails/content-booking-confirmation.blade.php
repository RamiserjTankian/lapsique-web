...
@section('content')
    ...
    <p style="color: #e5e7eb;">
        Recibimos tu reserva para una <strong style="color: #ffffff;">sesión de contenido profesional</strong>
        (2 reels editados + 20 fotografías).
    </p>

    <div style="background-color: #0b0b0b; padding: 20px; border-radius: 12px; margin: 20px 0; border: 1px solid rgba(255, 255, 255, 0.12);">
        <h3 style="margin-top: 0; color: #ffffff;">Detalles de tu sesión</h3>
        @if ($slot)
