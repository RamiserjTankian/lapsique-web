...
function ReelMosaicCell({
    ...
    return (
        <div className={`relative overflow-hidden bg-black ${className}`} aria-hidden>
            <AutoplayVideo
                src={video.src}
                poster={video.poster}
            ...
            <div className="relative flex min-h-[min(380px,85svh)] flex-col justify-between p-5 md:min-h-[420px] md:p-6">
                <div className="flex flex-wrap gap-2">
                    ...
                    <OfferPill icon={<Plane className="h-3.5 w-3.5" aria-hidden />}>
                        {CONTENT_DRONE_SHOTS} tomas dron DJI
                    </OfferPill>
                </div>
                ...
                <div className="max-w-xl">
                    ...
                    <p className="mt-3 max-w-lg text-sm leading-relaxed text-white/72">
                        Reel de {CONTENT_REEL_DURATION_SECONDS} segundos con {CONTENT_DRONE_SHOTS} tomas
                        aéreas DJI incluidas — paquete claro para pauta, Reels y campañas sin producción
                        indefinida.
                    </p>
                </div>
            </div>
