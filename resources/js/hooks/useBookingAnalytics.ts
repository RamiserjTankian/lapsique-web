...
const STANDARD_EVENTS: Record<string, string> = {
    ...
    content_creation_page_viewed: 'ViewContent',
    content_creation_whatsapp_cta_clicked: 'Contact',
    business_reels_page_viewed: 'ViewContent',
    business_reels_whatsapp_cta_clicked: 'Contact',
...
const GA_EVENT_NAMES: Record<string, string> = {
    ...
    content_creation_page_viewed: 'view_service_landing',
    business_reels_page_viewed: 'view_service_landing',
    content_creation_booking_cta_clicked: 'booking_cta_click',
    business_reels_booking_cta_clicked: 'booking_cta_click',
    ...
    business_reels_whatsapp_cta_clicked: 'whatsapp_click',
...
const CUSTOM_META_EVENT_ALIASES: Record<string, string> = {
    ...
    business_reels_booking_cta_clicked: 'BookingCtaClick',
    ...
    business_reels_whatsapp_cta_clicked: 'WhatsAppClick',
