...
class MetaPixelClientTest extends TestCase
{
    public function test_pixel_client_supports_inertia_and_blade_queues_with_event_ids(): void
    {
        ...
        $this->assertStringContainsString("electronic_event_coverage_booking_cta_clicked: 'BookingCtaClick'", $analyticsHook);
        $this->assertStringContainsString("electronic_event_coverage_whatsapp_cta_clicked: 'WhatsAppClick'", $analyticsHook);
        ...
        $this->assertStringContainsString("'electronic-event-coverage.show' => 'electronic_event_coverage'", $inertiaLayout);
